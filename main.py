...
if __name__ == "__main__":
    ...
    #print(neo4j_wrapper.get_top_actors(2010, 2015))
    #print(neo4j_wrapper.get_top_directors(2010, 2015))
    #print(neo4j_wrapper.get_actor_couples().to_dict("records"))
    nx_wrapper.gen_actor_couples_graph()